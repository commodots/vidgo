...
{
    global $mysqli;
    if($video_id!="" AND $user_id!="" AND $activity_type!="")
    {
        $qry = "SELECT * FROM tbl_users_rewards_activity WHERE  video_id = '".$video_id."' and user_id = '".$user_id."' and activity_type = '".$activity_type."'";
...
function checkSignSalt($data_info){
        ...
        if($data_arr['package_name']==PACKAGE_NAME){
            if($data_arr['sign'] == '' && $data_arr['salt'] == '' ){
                ...
                $set['status']=-1;
                $set['message']="You are using invalid License or Package name is already in use, for more information contact us: info@viaviweb.com or viaviwebtech@gmail.com";

                // $set['ANDROID_REWARDS_APP'][] = array("status" => -1, "message" => );
                ...
                if($data_arr['sign']!=$md5_salt){
                    ...
                    // $set['ANDROID_REWARDS_APP'][] = array("status" => -1, "message" => "You are using invalid License or Package name is already in use, for more information contact us: info@viaviweb.com or viaviwebtech@gmail.com");
            ...
            // $set['ANDROID_REWARDS_APP'][] = array("status" => -1, "message" => "Invalid package name");   

...
<div class="row">
    ...
    <div class="card mr_bottom20 mr_top10">
      ...
      <ul>
        ...
        <li><a href="manage_user_history_followings.php?user_id=<?php echo $users_res_row['id'];?>" style="color: #e91e63;"><?php echo $users_res_row['total_following'];?> Following</a></li>        
        ...
        <div class="row">
          ...
          <div class="col-md-3">
            <div class="user_followings_block">
              ...
              <h3><a href="manage_user_history.php?user_id=<?=$row_follow['user_id']?>"><?php echo get_user_info($row_follow['user_id'],'name');?></a>
                <?php 
              ...
              <a href="manage_user_history.php?user_id=<?php echo $row_follow['user_id'];?>" class="view_more_info">View Info</a>
            </div>
          </div>
          <?php

...
<div class="row">
    ...
    <div class="card mr_bottom20 mr_top10">
      ...
      <ul>
        ...
        <li><a href="manage_user_history_followers.php?user_id=<?php echo $users_res_row['id'];?>" style="color: #e91e63;"><?php echo $users_res_row['total_followers'];?> Followers</a></li>
    ...
    <div class="col-md-12">
      <div class="card">
        ...
        <div class="col-md-5 col-xs-12">
          <div class="page_title">Followers</div>
        </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-md-3">
            <div class="user_followings_block">
              ...
              <h3><a href="manage_user_history.php?user_id=<?=$row_follow['user_id']?>"><?php echo get_user_info($row_follow['follower_id'],'name');?></a>
                <?php 
              ...
              <a href="manage_user_history.php?user_id=<?php echo $row_follow['follower_id'];?>" class="view_more_info">View Info</a>
            </div>
          </div>
          <?php

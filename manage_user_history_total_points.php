...
<div class="row">
    ...
    <div class="card mr_bottom20 mr_top10">
      ...
      <ul>
        ...
        <li><a href="manage_user_history_total_points.php?user_id=<?php echo $users_res_row['id'];?>" style="color: #e91e63;">All Points History</a></li>
      </ul>
      </div>
    </div>
    </div>
    ...
    ?>
        <tr>
            <td>
              <?php 
                if(get_video_info($users_row['video_id'],'video_title')==''){
                  echo '#';
                }else{
                  echo get_video_info($users_row['video_id'],'video_title');
                }

...
<div class="row">
      <div class="col-sm-12 col-xs-12">
     	 	<div class="card">
                ...
                <br><b>Single Video View Count</b> (Method: single_video_view_count)(Parameter: video_id, user_id, owner_id)
                ...
                <br><b>User Register</b> (Method: user_register)(Parameter: type (google, normal), device_id, name, email, password, phone, user_refrence_code)
                <br><b>User Login</b> (Method: user_login)(Parameter: type, email, password, player_id)
                ...
                <br><b>User Video Upload</b>(File:api_video_upload.php) (Method: user_video_upload)(Post Parameter: user_id,cat_id,video_title,video_local,video_layout,video_thumbnail)
                ...
                <br><b>Video Comment Delete</b> (Method: delete_comment)(Parameter: comment_id, video_id)
                <br><b>Get Video Comments</b> (Method: get_all_comment) (Parameter: video_id, page) 
                ...
                <br><b>Get Contact Subject List</b> (Method: get_contact) 
